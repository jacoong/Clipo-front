...
exports.createApiServices = void 0;
function createApiServices({ instance, formInstance, request }) {
    const Axios = request;
    ...
    class AuthService {
        ...
        static async smsRequest(userData) {
        ...
        static async smsVerificate(userData) {
    ...
    class UserService {
        ...
        static async createNicknameProfileImg(userData) {
        ...
        static async userEditProfile(userData) {
    ...
    class SocialService {
        static async fetchPosts(pageIndex) {
        ...
        static async fetchUserPosts(value) {
        ...
        static async fetchedUserInfo(username) {
        ...
        static async createBoard(postData) {
        ...
        static async createReplyOrNestRe(postData) {
        ...
        static async folowUserAccount(userName) {
        ...
        static async unFolowUserAccount(userName) {
        ...
        static async boardlikeContents(idValue) {
        ...
        static async fetchFollowPost(pageIndex) {
            console.log(pageIndex, 'fetchFollowPost');
            const response = await instance.get(`api/board/get/postInfo/follow/${pageIndex}/`, {
                headers: {
                    'Content-Type': 'application/json',
                },
            });
        ...
        static async boardunlikeContents(idValue) {
        ...
        static async replylikeContents(idValue) {
        ...
        static async replyunlikeContents(idValue) {
        ...
        static async fetchedReplyDetail(rno) {
        ...
        static async fetchedReply(bno, pageIndex) {
        ...
        static async fetchedNestRe(rno, pageIndex) {
        ...
        static async fetchedFollowingFollower(value, page) {
        ...
        static async searchUserAccount(search, page) {
        ...
        static async searchHashTag(search, page) {
        ...
        static async deleteBoardRequest(bno) {
        ...
        static async deleteCommentRequest(rno) {
        ...
        static async fetchPostWithTags(value, pages) {
        ...
        static async fetchActivity(pages) {
        ...
        static async fetchReplyPageNumber(bno, rno) {
        ...
        static async fetchNestRePageNumber(parentId, targetId) {
...
exports.createApiServices = createApiServices;
